...
public class precios {
    ...
    private String Codigo_Precios;
    private String Precio_Menudeo;
    private String Precio_Mayoreo;
    private String Codigo_Producto;

    public String getCodigo_Precios() {
        return Codigo_Precios;
    }

    public void setCodigo_Precios(String Codigo_Precios) {
        this.Codigo_Precios = Codigo_Precios;
    }
